...
: init      0players 0behaviors 0viewable 0elasticity 0dimensions
            0mobility 0positionables 0objects ;

: s         init 1234 seeded 123 player ;
: tp0.1     s   123 score abort" tp0.1 score mismatch" ;

: tp0   tp0.1 ;

: s         init 2 seeded 123 player 456 player 789 player assigned ;
